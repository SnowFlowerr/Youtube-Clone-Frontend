...
export default function Signin() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            const userData = await axios.post("https://video-streaming-app-backend-production.up.railway.app/api/auth/login", { username: user.username, password: user.password }, { withCredentials: true });

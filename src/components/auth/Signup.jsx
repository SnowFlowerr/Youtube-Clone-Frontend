...
export default function Signup() {
    ...
    async function handleSubmit(e){
        ...
        try{
            const userData =await axios.post("https://honest-stillness-production.up.railway.app/api/auth/signup", {  name:user.name, username:user.username, email:user.email, password:user.password},{ withCredentials: true });

...
export default function Histories() {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            try {
                const userData = await axios.get("https://honeststillness-production.up.railway.app/api/users/history",
        ...
        async function fetchData2() {
            try {
                const userData = await axios.get("https://honeststillness-production.up.railway.app/api/users/shortshistory",
                    { withCredentials: true }
                );

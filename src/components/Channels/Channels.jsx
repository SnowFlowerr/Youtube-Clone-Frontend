...
export default function Channels() {
    ...
    async function currentUser() {
        try {
            const userD = await axios.get(
                `https://video-streaming-app-backend-production.up.railway.app/api/users/get/${id}`,
    ...
    async function issubscribe() {
        try {
            const userD = await axios.get(`https://video-streaming-app-backend-production.up.railway.app/api/users/issubscribe/${id}`,
                { withCredentials: true }
            )
    ...
    async function updateUser(url) {
        try {
            const userD = await axios.put(
                `https://video-streaming-app-backend-production.up.railway.app/api/users/update/${id}`,
                { bannerImg: url },
                { withCredentials: true }
            );
            setUser(userD.data);
    ...
    async function currentShorts() {
        try {
            const short = await axios.get(
                `https://video-streaming-app-backend-production.up.railway.app/api/shorts/allcurrentshorts/${id}?limit=${20}`,
                { withCredentials: true }
            );
    ...
    async function currentVideos() {
        try {
            const short = await axios.get(
                `https://video-streaming-app-backend-production.up.railway.app/api/videos/allcurrentvideos/${id}?limit=${20}`,
                { withCredentials: true }
            );
    ...
    async function handleSubscribe() {
        try {
            if (isSubs) {
                setisSubs(false)
                setSubs(subs - 1)
                await axios.delete(`https://video-streaming-app-backend-production.up.railway.app/api/users/unsubscribe/${id}`,
                ...
                setisSubs(true)
                setSubs(subs + 1)
                await axios.put(`https://video-streaming-app-backend-production.up.railway.app/api/users/subscribe/${id}`,
                    {},
                    { withCredentials: true }
                );

...
export default function VideoPlay() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const vidData = await axios.get(`https://honeststillness-production.up.railway.app/api/videos/${id}`)
                ...
                try {
                    const userD = await axios.get(`https://honeststillness-production.up.railway.app/api/users/issubscribe/${vidData.data.userId}`,
                ...
                try {
                    const userD = await axios.get(`https://honeststillness-production.up.railway.app/api/users/isliked/${id}`,
                        { withCredentials: true }
                    )
                ...
                try {
                    const userD = await axios.get(`https://honeststillness-production.up.railway.app/api/users/isdisliked/${id}`,
                        { withCredentials: true }
                    )
                ...
                try {
                    const userD = await axios.get(`https://honeststillness-production.up.railway.app/api/users/issaved/${id}`,
                        { withCredentials: true }
                    )
                ...
                try {
                    const userD = await axios.get(`https://honeststillness-production.up.railway.app/api/users/get/${vidData.data.userId}`,
                    )
    ...
    function handleSubscribe() {
        async function fetchData() {
            try {
                if (isSubs) {
                    await axios.put(`https://honeststillness-production.up.railway.app/api/users/unsubscribe/${videoData?.userId}`,
                        {},
                        { withCredentials: true }
                    );
                    setSubs(subs - 1)
                    ...
                    await axios.put(`https://honeststillness-production.up.railway.app/api/users/subscribe/${videoData?.userId}`,
                        {},
                        { withCredentials: true }
                    );
                    setSubs(subs + 1)
    ...
    async function handleLike() {
        ...
        try {
            if (isLike) {
                await axios.put(`https://honeststillness-production.up.railway.app/api/videos/unlike/${id}`,
                ...
                await axios.put(`https://honeststillness-production.up.railway.app/api/videos/like/${id}`,
                    { headers: { "Content-Type": "application/json" } },
                    { withCredentials: true }
                );
                setLike(like + 1)
    ...
    async function handleDislike() {
        try {
            if (isDislike) {
                await axios.put(`https://honeststillness-production.up.railway.app/api/videos/undislike/${id}`,
                    {},
                    { withCredentials: true }
                );
                ...
                await axios.put(`https://honeststillness-production.up.railway.app/api/videos/dislike/${id}`,
                    {},
                    { withCredentials: true }
                );
                setDislike(dislike + 1)
    ...
    async function addView() {
        try {
            await axios.put(`https://honeststillness-production.up.railway.app/api/videos/view/${id}`)
            setView(view + 1)
        }
        catch (err) {
            console.log(err.message)
    ...
    async function addHistory() {
        try {
            await axios.put(`https://honeststillness-production.up.railway.app/api/users/history/${id}`,
                {},
                { withCredentials: true }
            );
        }
    ...
    async function addSaved() {
        try {
            if (isSaved) {
                await axios.put(`https://honeststillness-production.up.railway.app/api/users/removesave/${id}`,
                    {},
                    { withCredentials: true }
                );
                console.log("removed")
                ...
                await axios.put(`https://honeststillness-production.up.railway.app/api/users/addsave/${id}`,
                    {},
                    { withCredentials: true }
                );
                console.log("saved")

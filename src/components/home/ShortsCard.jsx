...
export default function ShortsCard({video , index}) {
    ...
    return (
        <>
            <div className={index===5?styles.singleVid2:index===4?styles.singleVid3:index===3?styles.singleVid4:index===2?styles.singleVid5:styles.singleVid} style={theme ? darkTheme : lightTheme}  onMouseLeave={handleStop} onMouseEnter={handlePlay}>
                {/* {!isPlaying ? */}
                ...
                <div className={styles.videoDetail} style={theme ? darkTheme : lightTheme}>
                    ...
                    <div className={styles.details} style={theme ? { color: "white" } : { color: "black" }}>
                            <div className={styles.title} onClick={()=>`/shorts/${video?._id}`}>
                                {video?.title}
                            </div>

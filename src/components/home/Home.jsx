...
export default function Home() {
    ...
    useEffect(() => {
        const fetchVideo = async () => {
            try {
                const res = await axios.get(`https://video-streaming-app-backend-production.up.railway.app/api/videos/?limit=${20}&skip=${skip}`)
    ...
    useEffect(() => {
        const fetchShorts = async () => {
            try {
                const res = await axios.get(`https://video-streaming-app-backend-production.up.railway.app/api/shorts/?limit=${6}&skip=${0}`)
                // console.log(res.data)
                setShorts(res.data)
            }
            catch (err) {
